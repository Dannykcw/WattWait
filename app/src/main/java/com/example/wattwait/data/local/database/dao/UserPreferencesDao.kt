...
interface UserPreferencesDao {
    ...
    @Query("UPDATE user_preferences SET zipCode = :zipCode, latitude = :latitude, longitude = :longitude, address = :address WHERE id = 1")
    suspend fun updateLocation(zipCode: String?, latitude: Double?, longitude: Double?, address: String?)
